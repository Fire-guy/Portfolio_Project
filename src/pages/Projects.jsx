          ...
          {projects.map((project)=>(
            <div className="lg:w-[400px] w-full " key={project.name}>
              ...
              <div className="mt-5 flex flex-col">
                ...
                <div className="mt-5 flex items-center gap-2 font-poppins"><Link to={project.link} target="_blank" rel="noopener noreferrer" className="font-semibold text-blue-600">Live Link</Link>
